...
typedef struct
{
	...
	uint8_t GPIO_PinSpeed;						/* Select from @GPIO_PIN_SPEEDS*/
	uint8_t GPIO_PinPuPdControl;				/* Select from @GPIO_PIN_PUPDC*/
	uint8_t GPIO_PinOPType;						/* Select from @GPIO_PIN_OUTPUT*/
